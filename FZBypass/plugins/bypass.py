...
async def start_msg(client, message):
    await message.reply(f'''<b><i>Roku Bypass Bot!</i></b>
...
🤖 <b>➜ </b> <a href=https://telegra.ph/How-To-Use-12-06></i>𝖧𝗈𝗐 𝖳𝗈 𝖴𝗌𝖾 𝖬𝖾</i></a>''',
        ...
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('⛅ 𝖴𝗉𝖽𝖺𝗍𝖾𝗌', url='https://t.me/Rokubotz'), InlineKeyboardButton('🌨️ 𝖲𝗎𝗉𝗉𝗈𝗋𝗍', url="https://t.me/Team_Roku")]
            ])
    )
